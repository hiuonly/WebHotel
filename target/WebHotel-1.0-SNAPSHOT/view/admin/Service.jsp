        ...
        <main class="content">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <!-- Button Modal -->
                    <form action="CreatS" method="POST">
                        <button type="button" class="btn btn-block btn-gray-800 mb-3" data-bs-toggle="modal" data-bs-target="#modal-default">Add new service</button>
                        <!-- Modal Content -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name="price" class="form-control" id="phone" type="number" placeholder="Price of service" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                    ...
                    <tbody>
                        <c:forEach items="${listC}" var="r">
                            <tr>
                                ...
                                <td>
                                    <c:if test="${r.status == 1}">
                                        <span class="fw-normal text-success">
                                            <a type="button" href="ListServiceT?cancel=${r.sid}">Available</a>
                                        </span>
                                    </c:if>
                                    <c:if test="${r.status == 0}">
                                        <span class="fw-normal text-warning">
                                            <a type="button" href="ListServiceT?done=${r.sid}">Unavailable</a>
                                        </span>
                                    </c:if>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="DeletS?sid=${r.sid}" title="Delete">
                                        <svg class="icon icon-xs text-danger ms-1" data-bs-toggle="tooltip" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd">

                                        </path>
                                        </svg>
                                    </a>
                                    <a href="UpdateS?id=${r.sid}" title="Update">
