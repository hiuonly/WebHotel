            ...
            <div class="row">
                <div class="col-12 mb-4">
                    <div class="card border-0 shadow components-section">
                        ...
                        <div class="card-body">
                            <form action="UDQ" method="POST">
                                <div class="row mb-4">
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            <div class="input-group">
                                                <label for="exampleInputIconLeft">User</label>
                                                <div class="input-group">
                                                <input name="user" type="text" class="form-control" id="exampleInputIconLeft"
                                                        value="${e.user}" readonly>
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleInputIconLeft">Password</label>
                                            <div class="input-group">

                                                <input name="pass" type="text" class="form-control" id="exampleInputIconLeft"
                                                        value="${e.pass}" readonly>
                                            </div>
                                        </div>
