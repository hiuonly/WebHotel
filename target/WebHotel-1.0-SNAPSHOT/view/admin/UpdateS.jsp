            ...
            <div class="row">
                <div class="col-12 col-xl-8">
                    <div class="card card-body border-0 shadow mb-4">
                        <h2 class="h5 mb-4">Update an service</h2>
                        <form action="UpdateS" method="POST">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div>
                                        <label for="first_name">Name Service</label>
                                        <input value="${s.name}" name="name" class="form-control" id="first_name" type="text" placeholder="Enter Name Service" required>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div>
                                        <input value="${s.sid}" name="id" hidden readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div>
                                        ...
                                        <img src="img/${s.shimage}" alt="" id="image" width="100" height="100">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 mb-3">
                                    <div>
                                        <label for="last_name">Type Service</label>
                                        <select name="type" class="form-select mb-0" id="gender">
                                            <c:forEach items="${listR}" var="e">
                                                <option value="${e.stid}">${e.name}</option>
                                            </c:forEach>
                                        </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-select mb-0" id="gender">
                                            <option value="1" ${s.status}>Available</option>
                                            <option value="0" ${s.status}>Unavailable</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input value="${s.price}" name="price" class="form-control" id="phone" type="number" placeholder="Price of service" required>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="phone">Desciblie</label>
                                        <input value="${s.describlie}" name="des" class="form-control" id="phone" type="text" placeholder="Description service" required>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-3">
