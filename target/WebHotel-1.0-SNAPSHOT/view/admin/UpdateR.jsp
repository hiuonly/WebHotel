                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div>
                                            ...
                                            <input name="number" class="form-control" id="first_name" type="text" value="${r.rid}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div>
                                        ...
                                        <img src="img/${r.aimg}" alt="" id="image" width="100" height="100">
                                        <input name="img1" class="form-control" id="imageFile" type="file" value="${r.aimg}"
                                               accept="image/gif, image/jpeg, image/jpg, image/png" onchange="chooseFile(this)"> 
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div>
                                        <label for="first_name">Img2 Room</label>
                                        <img src="img/${r.bimg}" alt="" id="image" width="100" height="100">
                                        <input name="img2" class="form-control" id="imageFile" type="file" value="${r.bimg}"
                                               accept="image/gif, image/jpeg, image/jpg, image/png" onchange="chooseFile(this)"> 
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div>
                                        ...
                                        <img src="img/${r.cimg}" alt="" id="image" width="100" height="100">
                                        <input name="img3" class="form-control" id="imageFile" type="file" value="${r.cimg}"
                                               accept="image/gif, image/jpeg, image/jpg, image/png" onchange="chooseFile(this)"> 
                                    </div>
                                </div>
                            </div>
                            <div class="row align-items-center">
                                <div class="col-md-6 mb-3">
                                    <div>
                                        ...
                                        <select name="typeroom" class="form-select mb-0" id="gender">
                                            <c:forEach items="${listR}" var="e">
                                                <option value="${e.rtid}" ${e.rtid eq r.rtid ? 'checked' : ''}>${e.roomtype}</option>
                                            </c:forEach>
                                        </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="birthday">Rank Room</label>
                                    <input class="form-control" name="rankroom" type="text" value="${r.rankRoom}" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="gender">Number People</label>
                                    <input name="people" class="form-control" id="last_name" type="number" value="${r.peoplenumber}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="email">Enter number bed</label>
                                        <input name="bed" class="form-control" id="email" type="number" value="${r.bednumber}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input name="price" class="form-control" id="phone" type="number" value="${r.priceroom}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input name="des" class="form-control" id="phone" type="text" value="${r.describle}" required>
                                    </div>
                                </div>
                            </div>
