            ...
            <nav class="navbar navbar-top navbar-expand navbar-dashboard navbar-dark ps-0 pe-2 pb-0">
                        ...
                        <div class="col-9 col-lg-8 d-md-flex">
                            <form action="SE" method="POST">
                                <div class="input-group me-2 me-lg-3 fmxw-300">
                                    ...
                                    <input name="txt" type="text" class="form-control" placeholder="Search Employees">
                                </div>
                            </form>
                        </div>
                ...
                <div class="card card-body shadow border-0 table-wrapper table-responsive">
                    <table class="table user-table table-hover align-items-center">
                        ...
                        <tbody>
                        <c:forEach items="${listE}" var="r">
                            <tr>

                                <td>

                                    <img src="img/team/${r.eimage}" class="avatar rounded-circle me-3" alt="Avatar">
                                    <div class="d-block">
                                        <span class="fw-bold">
                                            ${r.name}
                                        </span>
                                ...
                                <td>
                                    <a href="DE?rid=${r.usid}" title="Delete">
                                    ...
                                    <a href="UpE?id=${r.eid}" title="Update">
