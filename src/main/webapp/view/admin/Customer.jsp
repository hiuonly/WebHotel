                    ...
                    <div class="col-9 col-lg-8 d-md-flex">
                        <form action="SearchCus" method="POST">
                            <div class="input-group me-2 me-lg-3 fmxw-300">
                                ...
                                <input name="txt" type="text" class="form-control" placeholder="Search customer">
                            </div>
                        </form>
                    </div>
                        ...
                        <c:forEach items="${listU}" var="u">
                            <tr>
                                ...
                                <td>
                                        ...
                                        <img src="img/${u.cimage}" class="avatar rounded-circle me-3" alt="Avatar">
                                        <div class="d-block">
                                            <span class="fw-bold">
                                                ${u.name}
                                            </span>
                                ...
                                <td>
                                    <a href="DU?rid=${u.usid}" title="Delete">
