    ...
    <body>
        ...
        <main class="content">
            <nav class="navbar navbar-top navbar-expand navbar-dashboard navbar-dark ps-0 pe-2 pb-0">
                ...
                <form action="Describle" method="POST">
                    <div class="container content-gioithieu">
                        <h5>Description: ${v.rid}</h5>
                    <hr>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div>
                                <img src="img/${v.aimg}" alt="" id="image" width="200" height="200">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div>
                                <img src="img/${v.bimg}" alt="" id="image2" width="200" height="200">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div>
                                <img src="img/${v.cimg}" alt="" id="image3" width="200" height="200">
                            </div>
                        </div>
                    </div>
                    <hr>
