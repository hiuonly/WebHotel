                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            <div class="input-group">
                                                ...
                                                <input name="user" type="text" class="form-control" id="exampleInputIconLeft"
                                                        value="${e.user}" readonly hidden>
                                                <input name="id" type="text" class="form-control" id="exampleInputIconLeft"
                                                        value="${e.eid}" readonly hidden>
                                                <input name="usid" type="text" class="form-control" id="exampleInputIconLeft"
                                                        value="${e.usid}" readonly hidden>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                            <label for="image">Avatar</label>
                                            <img src="img/team/${e.eimage}" alt="" id="image" width="100" height="100">
                                            <input name="img" value="${e.eimage}" hidden>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="input-group">
                                                <input name="email" type="text" class="form-control" value="${e.email}" required readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            <label for="exampleInputIconRight">Birthday</label>
                                            <div class="input-group">
                                                ...
                                                <input name="birth" data-datepicker="" class="form-control" id="birthday" type="date" value="${e.birthday}"
                                                        required readonly>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input name="gender" data-datepicker="" class="form-control" id="birthday" type="text" value="${e.gender}"
                                                       required readonly>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="birthday">Position</label>
                                            <div class="input-group">

                                                <input name="pos" data-datepicker="" class="form-control" id="birthday" type="text" value="${e.position}"
                                                       required>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="birthday">CCCD</label>
                                            <div class="input-group">

                                                <input name="cccd" data-datepicker="" class="form-control" id="birthday" type="text" value="${e.cccd}"
                                                       required readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="my-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="address" type="text" class="form-control" id="exampleInputIconLeft" value="${e.address}"
                                                        readonly>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                            <label for="usernameValidate">Salary</label>
                                            <div class="input-group">
                                                <input name="salary" type="number" class="form-control" value="${e.salary}" required>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                            <label for="usernameValidate">Phone</label>
                                            <div class="input-group">
                                                <input name="phone" type="number" value="${e.sdt}" class="form-control" required readonly>
                                            </div>
                                        </div>
                                                <input name="pass" type="number" value="${e.pass}" class="form-control" required readonly hidden>
                                            <label for="firstName">Role: </label>
                                            <div class="input-group">
                                                <select name="role" class="form-select mb-0" id="gender">
