                ...
                <div class="table-settings mb-4">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-9 col-lg-8 d-md-flex">
                            <form action="SearchUSV" method="POST">
                                <div class="input-group me-2 me-lg-3 fmxw-400">
                                    ...
                                    <input name="txt" type="text" class="form-control" placeholder="Search customer use service">
                                </div>
                            </form>
                        </div>
                            ...
                            <tr>
                                <td>
                                    <a href="Vbill?id=${r.phid}" class="fw-bold">
                                        <img src="img/${r.simg}" class="avatar rounded-circle me-3" alt="Avatar">
                                        <div class="d-block">
                                            <span class="fw-bold">
                                                ${r.sname}
                                            </span>
